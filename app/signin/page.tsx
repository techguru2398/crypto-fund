            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded px-6 py-10 bg-secondary sm:p-[60px]">
                ...
                <div className="mb-8 flex items-center justify-center">
                  <span className="hidden h-[1px] w-full max-w-[70px] bg-gray-400/50 sm:block"></span>
                  ...
                  <div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
                    <div className="mb-4 sm:mb-0">
                      <label
                        ...
                        className="flex cursor-pointer select-none items-center text-sm font-medium text-gray-400"
                      >
